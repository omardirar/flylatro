...
from flylatro.learning.config import PlasticExperimentConfig, resolve_path


READINESS_VERSION = "flylatro-run-readiness-v1"
...
def _corpus(config: PlasticExperimentConfig) -> tuple[bool, str]:
    ...
    return True, "frozen reward-free calibration corpus is present"
